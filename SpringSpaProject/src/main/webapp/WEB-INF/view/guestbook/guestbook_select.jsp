...
<div id='guestbook_list'>
	...
	<form name='frm_gb_search' class='frm_gb_search' method='post'>
		<input type='text' size='60' name='findStr' value='${gVo.findStr }'/>
		<input type='button' value=' 검 색 ' class='btnSearch'/>
		...
		<c:forEach var='vo' items="${list}">
			<div class='item'>
				...
				<form name='frm_guestbook' class='frm_guestbook' method='post'>
					...
					<textarea rows="7" name='doc' readOnly>${vo.doc }</textarea>
					<br/>
					<div class='updateZone'>
						<label>암호</label>
						<input type='password' name='pwd' placeholder="작성했을때 암호">
